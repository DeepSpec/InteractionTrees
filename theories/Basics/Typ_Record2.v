 ...
 *)
Definition prod_typ (TA TB: typ) : typ :=
...
Definition arr_typ (TA TB: typ) : typ :=
  Typ (fun (f g: TA -> TB) => forall a1 a2, equal TA a1 a2 -> equal TB (f a1) (g a2)).
