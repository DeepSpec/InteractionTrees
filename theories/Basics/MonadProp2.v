...
(* The PropM monad (denoting Set) models nondeterministic behavior, similar to how
  List can be used to model nondeterminism.

  The monadic instance for List for modeling nondeterminism is as follows:
...
Module PropM.
  ...
  Definition fail: forall A, A -> PropM A := fun _ _ _ => False.
