...
Proof.
  intros E R. gcofix CIH. gstep. intros t1 t2 Hincl.
  ...
  - constructor. gbase. apply CIH. intros. apply Hincl. constructor. auto.
  - assert (H: is_traceF (VisF e k) (TEventEnd e)) by constructor.
    ...
    + constructor.
      ...
      * constructor. eapply IHis_traceF; eauto.
        intros. rewrite is_traceF_tau. apply Hincl; auto.
      * auto_inj_pair2. subst. constructor. intro. gbase. apply CIH. intros.
...
Proof.
  ...
  - apply trace_incl_sutt in H0. clear H.
    generalize dependent t1. generalize dependent t2. gcofix CIH; gstep; intros.
    gunfold H0. induction H0; constructor; try red; eauto with paco.
    gbase. rewrite itree_eta'. eauto with paco.
Qed.
