...
Proof.
  ...
  - rewrite tau_euttge. rewrite bind_trigger.
    gstep. constructor.
    intros; red. rewrite tau_euttge. auto with paco.
Qed.
...
Proof.
  ...
  rewrite unfold_interp, (unfold_interp_mrec _ t); cbn.
  destruct (observe t); cbn.
  - rewrite unfold_interp_mrec. rewrite tau_euttge. gstep. do 2 constructor.
  - rewrite unfold_interp_mrec. cbn; gstep; constructor; auto with paco.
  - destruct e; cbn.
    + gstep; constructor.
