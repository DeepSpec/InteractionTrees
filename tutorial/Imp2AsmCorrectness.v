...
Opaque sloop.
  ...
  Proof.
    ...
    (*
    simpl in x. cbn. dependent inversion x. unfold F, FinEmbedding in x. destruct x.
    intros [[] | []].
    - unfold ITree.cat. 
...
Qed.
  ...
  Proof.
    ...
    - (* While *)
      ...
      (* TODO: adapt [eq_locals_loop] to have [sloop] on the left hand side. *)
