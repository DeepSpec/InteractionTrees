...
Proof.
  ...
  step in REL. red in REL. hinduction Hsec before r; intros; inv Heqx; eauto.
  - remember (RetF r2) as y. hinduction REL before r; intros; inv Heqy; eauto with itree.
  - eapply IHHsec; eauto. pstep_reverse. setoid_rewrite <- tau_eutt at 1. step. auto.
  - remember (VisF e k2) as y.
    hinduction REL before r; intros; inv Heqy; ddestruction; subst; eauto with itree.
     unpriv_ind. eapply H0; eauto. pstep_reverse.
Qed.
...
Proof.
  ...
  step in REL. red in REL. remember (VisF e k) as y.
...
Proof.
  intros E Label priv l R1 R2 R3 RR1 RR2. coinduction c CIH. intros t1 t2 t3 Hsec Heutt.
  ...
  - genobs_clear t1 ot1.
    ...
    + destruct ot1; try (exfalso; eapply Ht1; eauto; fail).
      *  rewrite itree_eta'. rewrite itree_eta' in Hsec.
        eapply eses_aux3; eauto. step. constructor.
        left. auto.
  ...
  -  destruct (classic (leq (priv _ e) l ) ).
    ...
    + remember (VisF e k1) as y.
      hinduction Hsec before r; intros; inv Heqy; ddestruction; subst; try contradiction.
      * eauto with itree.
      *  unpriv_co. right. eapply CIH; eauto with itree. apply H.
      *  unpriv_co. right. eapply CIH; eauto with itree. apply H.
      * rewrite itree_eta'. unpriv_ind. eapply H0; eauto.
      * destruct (observe t0).
        ...
        -- destruct (classic (leq (priv _ e) l ) ).
           ...
           ++ destruct (classic_empty X).
              ** unpriv_halt. right. eapply CIH; eauto with itree. step. apply H.
              ** unpriv_co. right. eapply CIH; eauto with itree.
                 eapply unpriv_e_eqit_secure; eauto. step. apply H.
      *  unpriv_halt. right. eapply CIH; eauto. step.
        constructor; intros; auto with itree.
      *  unpriv_halt. right. eapply CIH; eauto with itree. apply H.
      *  unpriv_halt. right. eapply CIH; eauto with itree. apply H.
